...
\begin{titlingpage}
  ...
  {\Large Thesis Report GIRS-2017-10}\vspace{0.9cm}
...
All in all, temporal preprocessing of NDVI data resulted in 5 temporal parameters: mean NDVI, \nth{1} order amplitude, \nth{1} order phase, \nth{2} order amplitude and \nth{2} order phase.
