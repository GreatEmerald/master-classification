...
\begin{sidewaysfigure}
  ...
  \end{subfigure} \
  \caption{Visual comparison of fuzzy classification prediction output. Red, green and blue colour channels represent: b-d and q-t: cultivated, deciduous trees, evergreen trees; f-h: built-up, wetlands, water; j-l: built-up, deciduous trees, evergreen trees; n-p: barren, grass, evergreen trees, respectively.}
