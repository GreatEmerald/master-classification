...
\begin{table}
  \begin{center}
    \resizebox{\textwidth}{!}{
      \begin{tabular}{lllll}
	\hline
	Algorithm name & Supervised? & Fuzzy? & Single-model? & Based on\\
	\hline
	Fuzzy c-means & Partially & Yes & Yes & Feature space statistics\\
	Fuzzy neural network & Yes & Yes & Yes & Node weights\\
	Random forest regression & Yes & Yes & No & Decision trees\\
	Multiclass gradient boosting & Yes & Partially & Yes & Decision trees\\
	\hline
      \end{tabular}
    }
  \end{center}
