...
pures=which(as.logical(ScaleDataUntransf$pure))
set.seed(0xfedbeef)
ModelUntransf = neuralnet(Formula, ScaleDataUntransf[pures,], 9, lifesign="full", rep=10, threshold=0.05)
...
writeRaster(predicted, filename = paste0(OutputDir, "neuralnetwork-pure.tif"), progress="text",
